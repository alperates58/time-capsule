# Phase 02 — Deployment Foundation

## Goal
Coolify uyumlu Dockerfile, healthcheck, env örnekleri ve deploy notlarını hazırla.

## Expected Output
GitHub push sonrası deploy edilebilir app.
